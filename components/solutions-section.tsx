        ...
        <section className="bg-slate-50 relative overflow-hidden">
            ...
            <div className="py-16 sm:py-24">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    {/* Header / CTA Combined */}
                    <div className="relative rounded-3xl bg-[#0e7490] px-6 py-16 shadow-2xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 mb-24 overflow-hidden">
                        <div className="absolute -top-[100px] -left-[100px] w-[300px] h-[300px] bg-[#155e75] rounded-full blur-3xl opacity-50 mix-blend-multiply"></div>
                        <div className="absolute bottom-[0px] right-[0px] w-[300px] h-[300px] bg-[#0891b2] rounded-full blur-3xl opacity-50 mix-blend-multiply"></div>
                        ...
                        <div className="relative mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-8 lg:text-left">
                            ...
                            <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                                <a
                                    ...
                                    className="rounded-full bg-white px-8 py-3.5 text-sm font-semibold text-[#0e7490] shadow-sm hover:bg-cyan-50 hover:scale-105 transition-all duration-300"
                                >
                    ...
                    <div className="mx-auto max-w-2xl lg:max-w-none">
                        ...
                        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                            ...
                            <div className="group relative flex flex-col items-start bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 hover:-translate-y-2">
                                <div className="mb-6 inline-flex p-4 rounded-2xl bg-cyan-50 text-[#0e7490] group-hover:bg-[#0e7490] group-hover:text-white transition-colors duration-300">
                                    <Settings size={32} />
                                </div>
                                ...
                                <Link href="/#catalogo" className="flex items-center gap-2 text-sm font-bold text-[#0e7490] group-hover:gap-3 transition-all">
